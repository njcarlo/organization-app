...
export const EXPORT_COLLECTIONS = [
  ...
  { id: 'trackerDocuments', label: 'Documents & Assets', app: 'Tracker' },
  ...
  { id: 'trackerData', label: 'Data Projects', app: 'Tracker' },
  { id: 'boardCommitments', label: 'Board Commitments', app: 'Tracker' },
