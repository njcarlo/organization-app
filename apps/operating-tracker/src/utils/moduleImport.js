...
Founders Mixer,2026-08-15,6:00 PM,ET,2026-08-01,Boston,In-Person,Live event (in-person),Jamie Lee,,,Jamie Lee,,,ongoing`,
    ...
    mapRow(row) {
      ...
      return {
        ...
        zoomCoordinator: String(row.zoomCoordinator || '').trim(),
        guestSpeaker: String(row.guestSpeaker || '').trim(),
        reginaAvailable: String(row.reginaAvailable || '').trim(),
        health,
      }
    },
  },
