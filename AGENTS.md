...
1. Read **[`CLAUDE.md`](./CLAUDE.md)** (project facts + non-negotiables).
2. Follow rules in **[`.claude/rules/`](./.claude/rules/)** (coding, UI, Firebase, git).
3. Use skills in **[`.claude/skills/`](./.claude/skills/)** for repeatable workflows.
